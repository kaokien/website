...
If you close VS Code, you can always get back to this workspace by going to `File > Open Workspace` in VS Code's menu and then selecting your workspace file: `/Users/kadupoku/Dendron/dendron.code-workspace`
...
- [ ] Complete the Tutorial (Cmd+Click on the links to go to each tutorial note)
  - [ ] One: [Navigation Basics](/tutorial/1-navigation-basics)
  - [ ] Two: [Taking Notes](/tutorial/2-taking-notes)
  - [ ] Three: [Linking Your Notes](/tutorial/3-linking-your-notes)
  - [ ] Four: [Rich Formatting](/tutorial/4-rich-formatting)
  - [ ] Five: [Conclusion](/tutorial/5-conclusion)
